/**
 * Font: https://raw.githubusercontent.com/Reboog711/LearnWith/master/chapter4/angularApp/com/dotComIt/learnWith/controllers/MainScreenCtrl.js
 * This file has some change
 */
 ...
 angular.module('learnWith').controller('MainScreenCtrl', ['$scope','$location','$filter','UserModel','TaskModel','TaskService', function($scope,$location,$filter,UserModel,TaskModel,TaskService){
     ...
     onInit();
        ...
        $scope.allOptions = function (list) {
          var totalOptions = 0;
          angular.forEach(list, function (value, key) {
            totalOptions += parseFloat(key);
          });
          return totalOptions.toFixed(2);
        };
